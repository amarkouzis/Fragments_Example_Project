...
public class CitiesFragment extends Fragment {
    ...
    private Uri location, webpage;
    private String url, map;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Button icon1 = (Button) getActivity().findViewById(R.id.map);
        ...
        Button icon2 = (Button) getActivity().findViewById(R.id.search);
    ...
    public void onConnection(String region){
        if(region.equals("Viotia")){
            TextView text = (TextView) getActivity().findViewById(R.id.textCity);
